      ...
      <div className="min-h-screen bg-gradient-to-b from-red-50 via-white to-white pt-20 pb-10">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
            <div className="bg-white rounded-3xl p-5 shadow-lg border border-emerald-100">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h1 className="text-3xl font-black text-emerald-600 mt-2">{hadir}</h1>
                </div>
            ...
            <div className="bg-white rounded-3xl p-5 shadow-lg border border-yellow-100">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-gray-500 text-sm">Izin</p>
                  <h1 className="text-3xl font-black text-yellow-500 mt-2">{izin}</h1>
                </div>
            ...
            <div className="bg-white rounded-3xl p-5 shadow-lg border border-sky-100">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h1 className="text-3xl font-black text-sky-500 mt-2">{sakit}</h1>
                </div>
            ...
            <div className="bg-white rounded-3xl p-5 shadow-lg border border-red-100">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h1 className="text-3xl font-black text-red-500 mt-2">{alpha}</h1>
                </div>
